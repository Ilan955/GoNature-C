...
public class confirmationScreenController implements Initializable {
	...
	/*
	 * Setting the values of the confirmation based on what was set in the order and
	 * what set for the traveller who made the order
	 */
	...
	/*
	 * Showing the information for the user the information includes all the data of
	 * the order
	 */
	@Override
	...
	/*
	 * when the user will click on done, the stystem will: will insert the order
	 * into db will delete the current order from the "o" value
	 */
	...
	/*
	 * if the user click back, he will need to fill the form again with the ditails
	 * from here
	 */
	@FXML
