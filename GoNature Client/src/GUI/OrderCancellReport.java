...
public class OrderCancellReport  implements Initializable{
	    ...
	    /*
	     * This method will reach to the db, and get the data about the all amont of people that:
	     * 	1.canceled there order
	     * 	2. confirmed but didn't enter the park.
	     */
	    @FXML
