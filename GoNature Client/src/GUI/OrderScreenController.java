...
public class OrderScreenController implements Initializable {
  ...
  void WhenClickNextBtn(ActionEvent event) throws IOException {
    if (
      ClientUI.orderController.checkValidValues(
        PhoneNumberLbl.getText(),
        EmailLbl.getText()
      )
    ) {
      ...
      ClientUI.orderController.setEmailAndPhone(
        EmailLbl.getText(),
        PhoneNumberLbl.getText()
      );
      ClientUI.orderController.n_order = true;
      ClientUI.orderController.canMakeOrder(
        time,
        date,
        wanted,
        "Member",
      ...
      if (ClientUI.orderController.valid) {
        ...
        Pane root = loader.load(
          getClass().getResource("/GUI/Confirmation.fxml").openStream()
        );
        ...
        FXMLLoader loader = new FXMLLoader();
        Pane root = loader.load(
          getClass().getResource("/GUI/CancellOrder.fxml").openStream()
        );
        Scene scene = new Scene(root);
